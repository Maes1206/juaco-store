/* Artículos de demostración compartidos entre el listado y el detalle. */
(function () {
  'use strict';

  window.JuacoBlogArticles = {
    'siluetas-basket-urbanas': {
      ...
      body: 'Elige pares que se adapten a tu rutina y combínalos con prendas de cortes limpios. Los materiales resistentes y una paleta equilibrada permiten usarlos durante todo el año.',
      tags: ['Streetwear', 'Baloncesto', 'Estilo urbano']
    },
    'cuidado-sneakers-blancos': {
      ...
      body: 'Usa un cepillo suave, un paño de microfibra y agua jabonosa en poca cantidad. Déjalos secar a la sombra y guarda cada par lejos de la humedad.',
      tags: ['Cuidado', 'Sneakers blancos', 'Limpieza']
    },
    'combinar-sneakers-color': {
      ...
      body: 'Empieza con bases neutras: negro, blanco, gris o denim. Añade una prenda o accesorio que dialogue con el tono principal de tus sneakers y conserva el resto sobrio.',
      tags: ['Color', 'Outfits', 'Guía de estilo']
    },
    'sneakers-perfil-bajo': {
      ...
      body: 'Prueba el par con el tipo de media que usas normalmente y verifica que haya espacio en la puntera. Una buena suela y materiales transpirables harán la diferencia en el día a día.',
      tags: ['Comodidad', 'Perfil bajo', 'Guía de compra']
    },
    'siluetas-retro': {
      ...
      body: 'Busca perfiles de gamuza, cuero y suelas en tonos crema. Combínalos con pantalones rectos, camisetas básicas o capas ligeras para lograr un resultado atemporal.',
      tags: ['Retro', 'Terrace', 'Streetwear']
    },
    'cultura-colaboraciones': {
      ...
      body: 'Cuando evalúes una edición especial, revisa los materiales, la historia detrás del diseño y si el par encaja realmente con tu estilo personal.',
